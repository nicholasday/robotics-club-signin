...
function addMember(e) {
    e.preventDefault()
    Member.add().then(Member.current.clear).then(Member.all)
}
        ...
        return m("div.pa4", [
            ...
            m('div',
                ...
                m('form.center.measure.measure-narrow-ns.pa2', [
                    m("input.input-reset.w-100.pa2.ba.b--black-20[name='name'][placeholder='Name']",
                        {
                    ...
                    m("input.input-reset.lh-copy.white.b.ba.br3.bw0.bg-orange.ph3.pv2.f6.pointer[type='submit'][value='Add']")
                ])
            ),
